# 🔍 Claude Code 解包完整版 — 把 Claude Code 扒个精光 (Claude Code Unpacked: Complete Deep Dive)

**日期**: 2026-04-01
**原文链接**: [ccunpacked.dev](https://ccunpacked.dev/)
**HN 热度**: 🔥 **1124 points** | **403 comments**
...
本篇是对 ccunpacked.dev 的完整深度解读，结合 Claude Code 退化 Issue #42796 的数据，构成对 Claude Code 最完整的评估。

---

## 五大核心模块

### Chapter 1: Agent Loop（智能体循环）— 从按键到响应的 11 步
...
### Chapter 4: Tool System（工具系统）— 40+ MCP 工具
...
### Chapter 5: Command Catalog（命令目录）— 87 个斜杠命令
...
> "1124 points 说明大家都想看 Anthropic 的底裤。这个网站做到了。" — **HN 用户**

> "1,730 行的 query.ts 就撑起了整个 Claude Code？这既是优雅也是隐患。" — **HN 用户**

> "卧底模式暴露了 Anthropic 的自省——他们预料到代码会被分析，提前做了准备。" — **HN 用户**

> "隐藏功能的数量和质量惊人。Claude Code 还远未到最终形态。" — **HN 用户**

> "结合退化 Issue 来看，这个可视化分析的价值更高了——你能看到设计意图 vs 实际表现的差距。" — **HN 用户**

---

## 📎 推荐资源 / 延伸阅读

- [Claude Code 退化 Issue #42796](https://github.com/anthropics/claude-code/issues/42796) — 必须配合阅读
- [Vibe Coding 文化批判](https://bramcohen.com/p/the-cult-of-vibe-coding-is-insane) — Claude 团队使用 vibe coding 的后果
- [Anthropic 官方文档](https://docs.anthropic.com/) — 官方视角
- [MCP 协议规范](https://modelcontextprotocol.io/) — 工具系统的底层协议
