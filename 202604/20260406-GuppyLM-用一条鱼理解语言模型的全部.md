# 🐟 GuppyLM — 用一条鱼理解语言模型的全部 (GuppyLM: Demystifying How Language Models Work)

**日期**: 2026-04-06
**原文链接**: [GitHub - arman-bd/guppylm](https://github.com/arman-bd/guppylm)
**HN 热度**: **894 points** | **133 comments**
...
| 只支持单轮对话？ | 多轮对话在第 3-4轮因 128 token 窗口而质量下降。鱼会忘东西，这很 on-brand |
...
> "这是我见过的最好的 LLM 教育项目。比任何教程都直观。" — **HN 用户**

> "终于有一个项目让我能向非技术朋友解释 Transformer 是怎么工作的了。" — **HN 用户**

> "5 分钟训练、浏览器运行、有趣的个性——这就是教育软件应该有的样子。" — **HN 用户**

> "Guppy 的回答太可爱了。'food. the answer is always food.' 这条鱼比我懂人生。" — **HN 用户**

> "如果大学课程都用这种项目教 ML，学生理解力会提升一个数量级。" — **HN 用户**

---

## 📎 推荐资源 / 延伸阅读

- [Google Colab - 使用预训练模型](https://colab.research.google.com/github/arman-bd/guppylm/blob/main/use_guppylm.ipynb)
- [Google Colab - 从零训练](https://colab.research.google.com/github/arman-bd/guppylm/blob/main/train_guppylm.ipynb)
- [Andrej Karpathy's nanoGPT](https://github.com/karpathy/nanoGPT) — 另一个极简 LLM 实现参考
- [Jay Alammar's The Illustrated Transformer](http://jalammar.github.io/illustrated-transformer/) — Transformer 图解教程
